...
class Header extends Component {
  ...
  render() {
    return (
      <header className="bg-dark text-light col-12 d-flex justify-content-between p-2 align-items-center border border-2 border-secondary border-top-0 border-start-0 border-end-0 ">
        <h1>Mastrocola.io</h1>
        <button
